      ...
      <div className="row">
        ...
        <div className="col-md-6 text-center">
          ...
          <div className="d-flex justify-content-center gap-2 mt-3">
            <img src={product.image} alt="thumb1" width={60} height={60} className="border p-1" />
            <img src={product.image} alt="thumb2" width={60} height={60} className="border p-1" />
            <img src={product.image} alt="thumb3" width={60} height={60} className="border p-1" />
          </div>
        </div>
        ...
        <div className="col-md-6">
          ...
          <p className="text-secondary mb-2">Category: <strong>{product.category}</strong></p>
          <p className="text-muted">{product.description}</p>

          <div className="my-3">
            <span className="fs-3 fw-bold text-danger">₹{product.price}</span>
            <span className="text-muted text-decoration-line-through ms-3">₹{product.price * 2}</span>
